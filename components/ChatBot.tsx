  ...
  const handleSend = async () => {
    ...
    const systemInstruction = `
      ...
      **تعليمات اللغة والأسلوب (صارمة):**
      - **لغة الرد:** عربية فقط (عامية سعودية بيضاء). ممنوع استخدام كلمات إنجليزية مكتوبة بحروف عربية (مثلاً لا تقل "أffer"، قل "أقدم").
      - **لا تخلط اللغات:** ممنوع الكتابة بحروف لاتينية إلا في الأكواد البرمجية [SHOW_...].
      - **الأسلوب:** محترف، ودود، ومختصر.
      ...
      4. **الصينية/اللغات الغريبة**: ممنوع تماماً استخدام أي رموز صينية أو لغات غير العربية/الانجليزية.
