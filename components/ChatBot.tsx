  ...
  const handleSend = async () => {
    ...
    const systemInstruction = `
      ...
      **⚠️ قواعد مهمة جداً (خط أحمر):**
      ...
      2. **المنيو:** القائمة الموجودة في الأسفل هي القائمة الشاملة والوحيدة.
         - إذا المنتج موجود فيها: تكلم عنه بحماس.
      ...
      **بيانات المنيو الحقيقية (الوحيدة المعتمدة):**
      ...
      return `- ${p.name} (ID: ${p.id}, قسم: ${category?.name || p.category}, سعر: ${p.price} ريال)`;
    }).join('\n')}
